...
|------|------|-----------|----------------|
| Chat | [chat.html](dist/chat.html) | [Prompt API](https://developer.chrome.com/docs/ai/prompt-api) | 145+ (Origin Trial) |
...
The Prompt API for web pages is currently in [origin trial](https://developer.chrome.com/origintrials/#/view_trial/2533837740349325313). To use on localhost, you need Chrome 145 or later and must enable the following Chrome flags:
